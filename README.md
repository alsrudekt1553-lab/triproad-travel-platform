...
이번 프로젝트를 진행하면서 가장 즐거웠던 점은
사용자가 실제로 사용하게 될 기능을 직접 고민하고 구현해 보는 과정이었습니다.

특히 여행 일정에 따른 캘린더 표시, 체크리스트 기능,
예약 상태에 따른 후기 작성 기능처럼 단순 CRUD를 넘어
사용자의 편의성을 높일 수 있는 기능을 직접 설계해 볼 수 있었습니다.

앞으로도 단순히 기능을 구현하는 개발자가 아니라,
사용자의 입장에서 더 편리한 서비스를 고민하는 개발자로 성장하고 싶습니다.
